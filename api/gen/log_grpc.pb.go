...
type LogServiceClient interface {
	Log(ctx context.Context, in *LogEntry, opts ...grpc.CallOption) (*LogResponse, error)
}
...
func (c *logServiceClient) Log(ctx context.Context, in *LogEntry, opts ...grpc.CallOption) (*LogResponse, error) {
...
type LogServiceServer interface {
	Log(context.Context, *LogEntry) (*LogResponse, error)
}
...
func (UnimplementedLogServiceServer) Log(context.Context, *LogEntry) (*LogResponse, error) {
