...
type LogEntry struct {
	...
	ShellPid             int32                  `protobuf:"varint,4,opt,name=shell_pid,json=shellPid,proto3" json:"shell_pid,omitempty"`
...
func (x *LogEntry) Reset() {
	*x = LogEntry{}
	mi := &file_api_proto_log_proto_msgTypes[0]
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return file_api_proto_log_proto_rawDescGZIP(), []int{0}
}
...
func (x *LogEntry) GetShellPid() int32 {
	if x != nil {
		return x.ShellPid
	}
	return 0
...
var File_api_proto_log_proto protoreflect.FileDescriptor

const file_api_proto_log_proto_rawDesc = "" +
	"\n" +
	"\x13api/proto/log.proto\x12\x03log\"\xdd\x04\n" +
	"\bLogEntry\x12\x18\n" +
	...
	"\x13logged_successfully\x18\x13 \x01(\bR\x12loggedSuccessfullyB;Z9github.com/willrabalais/terminalLog/api/generated/log;logb\x06proto3"

var (
	file_api_proto_log_proto_rawDescOnce sync.Once
	file_api_proto_log_proto_rawDescData []byte
)

func file_api_proto_log_proto_rawDescGZIP() []byte {
	file_api_proto_log_proto_rawDescOnce.Do(func() {
		file_api_proto_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_log_proto_rawDesc), len(file_api_proto_log_proto_rawDesc)))
	})
	return file_api_proto_log_proto_rawDescData
}

var file_api_proto_log_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_proto_log_proto_goTypes = []any{
	(*LogEntry)(nil), // 0: log.LogEntry
}
var file_api_proto_log_proto_depIdxs = []int32{
...
func init() { file_api_proto_log_proto_init() }
func file_api_proto_log_proto_init() {
	if File_api_proto_log_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_log_proto_rawDesc), len(file_api_proto_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_proto_log_proto_goTypes,
		DependencyIndexes: file_api_proto_log_proto_depIdxs,
		MessageInfos:      file_api_proto_log_proto_msgTypes,
	}.Build()
	File_api_proto_log_proto = out.File
	file_api_proto_log_proto_goTypes = nil
	file_api_proto_log_proto_depIdxs = nil
}
